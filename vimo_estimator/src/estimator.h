...
class Estimator
{
  public:
    ...
    // interface
    void processIMUandThrust(double t, const Vector3d &linear_acceleration, const Vector3d &angular_velocity, double Fz);
    ...
    double Fz_0; // mass normalised thrust [m/s2] in the body z axis
